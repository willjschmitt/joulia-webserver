...
urlpatterns = [
    ...
    url(r"api/yeast_ingredient/(?P<pk>[0-9]+)/$",
        views.YeastIngredientDetailView.as_view()),
    ...
    url(r"api/malt_ingredient_addition/$",
        views.MaltIngredientAdditionListView.as_view()),
    url(r"api/malt_ingredient_addition/(?P<pk>[0-9]+)/$",
        views.MaltIngredientAdditionDetailView.as_view()),
    url(r"api/bittering_ingredient_addition/$",
        views.BitteringIngredientAdditionListView.as_view()),
    url(r"api/bittering_ingredient_addition/(?P<pk>[0-9]+)/$",
        views.BitteringIngredientAdditionDetailView.as_view()),
